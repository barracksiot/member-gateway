...
The following document describes the Management API of Barracks.
...
=== Base URL
If you use the SaaS version of Barracks available on https://app.barracks.io, the _Base URL_ of the Management API is https://app.barracks.io/v2/api/member. +
If you use an On Premise version of Barracks and you're not sure what your _Base URL_ is, please contact us.

=== Request example
[source,bash]
----
$ curl 'https://app.barracks.io/v2/api/member/devices' -H 'Accept: application/json' -H 'x-auth-token:YzEyYThjMi01ODhjLTRie9.eyJqdGkiOiI4yJhbGciOiJIUzUxMiJ...'
----
...
include::docs/events.adoc[]

include::docs/filters.adoc[]

include::docs/packages.adoc[]
